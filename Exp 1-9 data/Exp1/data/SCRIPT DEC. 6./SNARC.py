...
dlg = gui.DlgFromDict(exp_info, title='SNARC', fixed=['dateStr', 'exp_id'],
                      order = ['participant', 'notation', 'response_buttons', 'autopilot'],
...
text_stimulus = visual.TextStim(win, pos=[0, 0], height = 50, text="dummy")
...
# Instruction
text_instruction = visual.TextStim(win, pos=[0,0], text=u"A képernyőn egy háromszöget fogsz látni. Ha a háromszög felfelé mutat, akkor nyomd meg a '"+exp_info['response_buttons'][0]+u"' billentyűt. Ha a háromszög lefelé mutat, nyomd meg a '"+exp_info['response_buttons'][1]+u"' billentyűt.\n\nA háromszög mögött "+(u'egy arab számot' if exp_info['notation']=='arabic' else u'pontokat')+u' láthatsz, amivel semmi tennivalód nincs, azt figyelmen kívül hagyhatod.\n\nNyomj egy gombot, ha kezdhetjük.')
